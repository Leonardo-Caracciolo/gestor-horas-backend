...
class Settings(BaseSettings):
    ...
    # ── Database ───────────────────────────────────────────
    # Soporta tanto DB_NAME como DB_DATABASE (compatibilidad con el equipo)
    DB_SERVER: str
    DB_PORT: int = 1433
    DB_DATABASE: str          # nombre en el .env del equipo
    DB_USER: str
    DB_PASSWORD: str
    ...
    def DB_NAME(self) -> str:
        """Alias para DB_DATABASE — usado internamente por SQLAlchemy."""
